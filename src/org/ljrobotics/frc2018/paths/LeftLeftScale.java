...
public class LeftLeftScale implements PathContainer {

    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(20,240,0,60));
        sWaypoints.add(new Waypoint(50,240,20,60));
        sWaypoints.add(new Waypoint(100,260,0,60));
        sWaypoints.add(new Waypoint(150,280,40,60));
        sWaypoints.add(new Waypoint(200,280,0,60));
        sWaypoints.add(new Waypoint(280,280,0,60));
