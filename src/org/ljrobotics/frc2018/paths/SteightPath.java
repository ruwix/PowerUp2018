...
public class SteightPath implements PathContainer {

    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(20,70,0,60));
        sWaypoints.add(new Waypoint(113,70,0,60));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(20, 70), Rotation2d.fromDegrees(0.0));
    }
